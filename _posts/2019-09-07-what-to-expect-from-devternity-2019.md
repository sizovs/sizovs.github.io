...
You'll learn practical techniques that architects and tech leads can use to achieve that goal. Roy will share do's and don'ts from the hard won battles in the field. Roy will also run a workshop "Elastic Leadership".
